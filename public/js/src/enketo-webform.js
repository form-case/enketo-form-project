...
if (settings.offline) {
    ...
    console.log('App in offline mode.');
    ...
    store
        ...
        .then((survey) => {
            ...
            // En modo offline, omitimos la solicitud de tamaño máximo y pasamos directamente a la inicialización
            survey.maxSize = settings.maxSize; // Asignar un valor predeterminado si es necesario
            return survey;
        })
        .then(_updateMaxSizeSetting)
        .then(_init)
...
function _updateMaxSizeSetting(survey) {
    if (survey.maxSize) {
        // Sobrescribir el tamaño máximo predeterminado si se ha especificado
